-- Fix commission RPCs to join by seller_id instead of seller_name.
-- Joining by name is fragile; seller_id already holds the correct ID for both
-- in-house (Seller Id) and broker (Broker ID) reservations.
