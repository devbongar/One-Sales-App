-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: update get_commission_summary to include 'Reserved-paid' status
-- Previously only returned 'Approved' reservations — commission schedule is
-- generated when status becomes 'Reserved-paid', so we need both.
-- ─────────────────────────────────────────────────────────────────────────────
...
language sql security definer as $$
  ...
  where r.status in ('Approved', 'Reserved-paid')
