-- Add chain ID columns to get_seller_recruits RPC so the seller recruitment
-- edit form can read and preserve them on save.
...
grant execute on function public.get_seller_recruits() to authenticated;
