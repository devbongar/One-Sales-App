-- Add optional p_reservation_id parameter to generate_penalty_lines so the
-- Settings Preview button can regenerate a single reservation instead of all.
  ...
  loop
    ...
    on conflict (receivable_line_id) do update
      set
        ...
        -- Never let penalty_amount drop below what has already been collected on Partial rows
