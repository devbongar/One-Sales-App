// Philippine Standard Geographic Code (PSGC) — provinces and cities/municipalities
// Used for cascading dropdowns in address forms when country = Philippines
...
export const PH_CITIES: Record<string, string[]> = {
  ...
  'La Union': [
    ...
    'San Fernando City', 'San Gabriel', 'San Juan', 'Santo Tomas', 'Santol',
    'Sudipen', 'Tubao',
  ],
  'Pangasinan': [
  ...
  'Cagayan': [
    ...
    'Peñablanca', 'Piat', 'Rizal', 'Sanchez-Mira', 'Santa Ana',
  ...
  'Pampanga': [
    ...
    'San Fernando City', 'San Luis', 'San Simon', 'Santa Ana',
  ...
  'Palawan': [
    ...
    'El Nido', 'Kalayaan', 'Linapacan', 'Magsaysay', 'Narra',
  ...
  'Bohol': [
    ...
    'Danao', 'Dauis', 'Dimiao', 'Duero', 'Garcia Hernandez', 'Guindulman',
    'Inabanga', 'Jagna', 'Jetafe', 'Lila', 'Loay', 'Loboc', 'Loon',
    'Mabini', 'Maribojoc', 'Panglao', 'Pilar', 'Pres. Carlos P. Garcia',
  ...
  'Cebu': [
    ...
    'Consolacion', 'Cordova', 'Dalaguete', 'Danao City', 'Dumanjug',
    'Ginatilan', 'Lapu-Lapu City', 'Liloan', 'Madridejos', 'Malabuyoc',
    'Mandaue City', 'Medellin', 'Minglanilla', 'Moalboal', 'Naga City',
  ...
  'Leyte': [
    'Abuyog', 'Alangalang', 'Albuera', 'Babatngon', 'Baybay City',
    ...
    'Matag-ob', 'Matalom', 'Mayorga', 'Merida', 'Ormoc City', 'Palo',
    'Palompon', 'Pastrana', 'San Isidro', 'San Miguel', 'Santa Fe',
    'Tabango', 'Tabontabon', 'Tacloban City', 'Tanauan', 'Tolosa',
    'Tunga', 'Villaba',
  ],
  'Northern Samar': [
  ...
  'Southern Leyte': [
    ...
    'Limasawa', 'Maasin City', 'Macrohon', 'Padre Burgos', 'Pintuyan',
  ...
  'Zamboanga del Norte': [
    ...
    'President Manuel A. Roxas', 'Rizal', 'Roxas', 'Salug', 'San Jose',
  ...
  'Zamboanga del Sur': [
    ...
    'Mahayag', 'Margosatubig', 'Midsalip', 'Molave', 'Pitogo',
  ...
  'Zamboanga Sibugay': [
    ...
    'Malangas', 'Naga', 'Olutanga', 'Payao', 'Ramon Magsaysay',
    'Roseller T. Lim', 'Siay', 'Talusan', 'Titay', 'Tungawan',
  ],
  'Bukidnon': [
  ...
  'Misamis Oriental': [
    ...
    'Claveria', 'El Salvador City', 'Gitagum', 'Initao', 'Jasaan',
  ...
  'Davao del Norte': [
    ...
    'Panabo City', 'Samal City', 'San Isidro', 'Santo Tomas', 'Tagum City',
    'Talaingod',
  ],
  'Davao del Sur': [
  ...
  'Cotabato': [
    'Alamada', 'Allah Valley', 'Aleosan', 'Antipas', 'Arakan', 'Banisilan',
    'Carmen', 'Kabacan', 'Kidapawan City', 'Libungan', 'Magpet', 'Makilala',
    'Matalam', 'Midsayap', 'Mlang', 'Pigkawayan', 'Pikit',
  ...
  'Lanao del Sur': [
    ...
    'Capanir', 'Ditsaan-Ramain', 'Ganassi', 'Lumba-Bayabao',
    ...
    'Saguiaran', 'Sultan Dumalondong', 'Sultan Gumander', 'Tagoloan II',
  ...
  'Maguindanao del Sur': [
    'Buluan', 'Datu Abdullah Sangki', 'Datu Anggal Midtimbang',
